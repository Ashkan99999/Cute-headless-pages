...
/**
 * Represents UserRegister records as resources.
 *
 * @RestResource (
 *   id = "cute_user_register",
 *   label = @Translation("UserRegister"),
 *   uri_paths = {
 *     "create" = "/api/cute-user/register"
 *   }
 * )
 *
 * @DCG
...
class UserRegisterResource extends ResourceBase {
  ...
  public function post(array $data) {
    ...
    $user =  $this->userService->userRegister($data);
